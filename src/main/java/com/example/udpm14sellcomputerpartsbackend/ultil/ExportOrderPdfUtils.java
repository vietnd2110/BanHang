...
public class ExportOrderPdfUtils {
    public ByteArrayInputStream exportPdf(List<ExportPdfOrderDto> exportPdfDTOS, Long total, String userName, String dis, String description, String maHD) {
        ...
        try {
            ...
            font.setColor(22, 20, 60);
            font.setStyle(Font.BOLD);


            Paragraph paragraph1 = new Paragraph("CỬA HÀNG BÁN PHẦN CỨNG MÁY TÍNH",
                    new Font(font));
            paragraph1.setIndentationLeft(55);
            paragraph1.setIndentationRight(55);
            paragraph1.setAlignment(Element.ALIGN_LEFT);
            paragraph1.setSpacingAfter(0);


            Paragraph paragraph2 = new Paragraph("___ HACOM ___                                              UY TÍN SỐ 1 VIỆT NAM", new Font(font));
            ...
            font.setSize(11.5f);
            Paragraph paragraph3 = new Paragraph("DC: 130/59 Mễ trì - Hà Nội \nSĐT: 0333456196 - 0866828826", new Font(font));
            ...
            font.setStyle(Font.BOLD);
            Paragraph paragraph4 = new Paragraph("CHUYÊN CUNG CẤP LẮP ĐẶT PHỤ KIỆN MÁY TÍNH", new Font(font));
            ...
            PdfPCell c1 = new PdfPCell(new Phrase("Mã SP", new Font(font)));
            t.addCell(c1);
            PdfPCell c2 = new PdfPCell(new Phrase("Tên SP", new Font(font)));
            t.addCell(c2);
            PdfPCell c3 = new PdfPCell(new Phrase("Số lượng", new Font(font)));
            t.addCell(c3);
            PdfPCell c4 = new PdfPCell(new Phrase("Giá", new Font(font)));
            t.addCell(c4);
            PdfPCell c5 = new PdfPCell(new Phrase("Tổng tiền", new Font(font)));
            t.addCell(c5);
            exportPdfDTOS.forEach(exportPdfDTO -> {
                t.addCell(exportPdfDTO.getCode());
            ...
            // Ghi chu
            font.setStyle(Font.BOLD);
            Paragraph paragraph6 = new Paragraph("GHI CHÚ: ", new Font(font));
            ...
            //+
            font.setStyle(Font.NORMAL);
            Paragraph paragraph7 = new Paragraph(description, new Font(font));
            ...
            // lưu ý
            font.setStyle(Font.BOLD);
            Paragraph paragraph8 = new Paragraph("LƯU Ý: ", new Font(font));
            ...
            //+
            font.setStyle(Font.NORMAL);
            Paragraph paragraph9 = new Paragraph("Thưa quý khách chúng tôi có giá ưu đãi cho khách hàng mua: \n - Quý khách giữ lại giấy đảm bảo để tiện mua bán và đổi trả \n - Sản phẩm của quý khách được bảo hành 12 tháng và đổi trả trong vòng 7 ngày ", new Font(font));
            ...
            font.setStyle(Font.BOLD);
            Paragraph paragraph10 = new Paragraph("Rất hân hạnh được phục vụ quý khách ! ", new Font(font));
            paragraph10.setSpacingBefore(5);
            paragraph10.setAlignment(Element.ALIGN_LEFT);
            paragraph10.setIndentationLeft(55);
            paragraph10.setIndentationRight(55);
            ...
            paragraph11.setIndentationRight(55);

            font.setStyle(Font.BOLD);
            Paragraph paragraph12 = new Paragraph("ĐẠI DIỆN CỬA HÀNG", new Font(font));
            paragraph12.setSpacingBefore(5);
            paragraph12.setAlignment(Element.ALIGN_RIGHT);
            paragraph12.setIndentationLeft(55);
            paragraph12.setIndentationRight(75);

            font.setStyle(Font.NORMAL);
            Paragraph paragraph13 = new Paragraph("Đã ký", new Font(font));
            paragraph13.setSpacingBefore(5);
            paragraph13.setAlignment(Element.ALIGN_RIGHT);
            paragraph13.setIndentationLeft(55);
            paragraph13.setIndentationRight(115);
